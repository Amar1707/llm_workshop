...
task = "endswith_a"  # name of task in case of fine-tuning. used to understand type of task and read its dataset
...
OUT_CHECKPOINT = "endswith_a.pt"  # checkpoint to write the model to
