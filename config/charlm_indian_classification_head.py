from model_exercise2_solution import GPT
...
model_extended_config = dict(n_classes=2, freeze=True)
...
OUT_CHECKPOINT = "indian_classification_head.pt"  # checkpoint to write the model to
